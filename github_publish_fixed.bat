...
echo Українська мова: працює правильно!
echo.
...
if not exist .git (
    ...
    echo.
    echo Запустіть спочатку git_init_fixed.bat
    pause
    exit /b 1
)
...
if %errorlevel% equ 0 (
    ...
    echo • git log --oneline -5          - останні 5 комітів
    echo.
    echo 🔒 ВАЖЛИВО:
...
REM Відправка develop гілки на GitHub
echo.
